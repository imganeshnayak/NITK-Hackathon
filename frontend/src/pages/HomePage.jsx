...
// Sample herb data with real image URLs from the internet
const recentHerbs = [
  {
    id: 1,
    name: 'Ashwagandha Root',
    image: 'https://images.unsplash.com/photo-1579684947554-1b34c08b69c2?w=400&h=400&fit=crop',
    batch: 'Batch ID: ASHW-24-001',
  },
  {
    id: 2,
    name: 'Brahmi Leaves',
    image: 'https://images.unsplash.com/photo-1577896854260-0d63b12c14f0?w=400&h=400&fit=crop',
    batch: 'Batch ID: BRM-25-015',
  },
  {
    id: 3,
    name: 'Turmeric Rhizome',
    image: 'https://images.unsplash.com/photo-1558618666-fcd25856cd25?w=400&h=400&fit=crop',
    batch: 'Batch ID: TRM-25-042',
  },
  {
    id: 4,
    name: 'Gotu Kola',
    image: 'https://images.unsplash.com/photo-1594736797936-d3d6fdc6d7b7?w=400&h=400&fit=crop',
    batch: 'Batch ID: GK-24-078',
  },
];
...
// Reusable Components
const HeroSection = memo(({ batchId, dispatch, isLoading, error }) => {
  const handleTrack = useCallback(() => {
    if (!batchId.trim()) {
      dispatch({ type: 'SET_ERROR', payload: 'Please enter a valid Batch ID' });
      return;
    }
  ...
  return (
    <section className="flex flex-col items-center justify-center text-center px-4 py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-800 dark:to-gray-900">
      ...
      <p className="mt-4 max-w-2xl text-lg text-gray-600 dark:text-gray-300">
        HerbChain brings transparency to the Ayurvedic supply chain. Scan a QR code or enter a batch ID to see the complete journey of your herbal products, from farm to you.
      </p>
      <div className="mt-8 flex flex-col sm:flex-row gap-4 w-full max-w-lg">
        ...
        >
          {isLoading ? 'Tracking...' : 'Track Harvest'}
        </button>
      </div>
...
const HerbCard = memo(({ herb, isFavorite, toggleFavorite }) => (
    ...
    <div className="relative p-4 flex justify-center">
      <div className="w-24 h-24 rounded-full bg-green-50 dark:bg-gray-700 flex items-center justify-center overflow-hidden">
        <img
          ...
          loading="lazy"
          onError={(e) => {
            e.target.src = 'https://images.unsplash.com/photo-1611095790444-222dda35d30c?w=400&h=400&fit=crop';
          }}
        />
      </div>
      <button
...
const FilterSection = memo(() => (
  <div className="mb-8 flex flex-col sm:flex-row justify-between items-start sm:items-center">
    <div>
      <h2 className="text-xl font-semibold text-gray-800 dark:text-white mb-4">Filter by:</h2>
      <div className="flex gap-2 flex-wrap">
        {['Herb Type', 'Origin', 'Certifications'].map((filter) => (
          <button
            key={filter}
    ...
    <div className="mt-4 sm:mt-0 flex items-center">
      ...
      <div className="ml-2 px-3 py-1 border border-gray-300 dark:border-gray-600 rounded-md text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 flex items-center">
    ...
    <div className="max-w-2xl mx-auto">
      <div className="relative rounded-lg overflow-hidden bg-gray-100 dark:bg-gray-700 aspect-square">
        <img
          ...
          alt="Map view for scanning QR code"
        ...
        <div className="absolute inset-0 border-4 border-dashed border-yellow-400 m-8 flex items-center justify-center">
          <div className="text-center text-yellow-600 dark:text-yellow-400">
            ...
            <p className="font-semibold">Scan QR Code Area</p>
          </div>
        </div>
      </div>
...
const ProvenanceCard = memo(() => (
  <section className="mb-16">
    <div className="flex items-center justify-between mb-4">
      <h2 className="text-2xl font-bold text-gray-800 dark:text-white">Provenance Card</h2>
    ...
    <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
      Transparently tracing the journey of your Ayurvedic herbs.
    </p>
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
      <div className="aspect-video relative rounded-lg overflow-hidden mb-6">
        <img
          src="https://images.unsplash.com/photo-1526772662000-3f88f10405ff?w=800&h=600&fit=crop"
      ...
      <div className="grid grid-cols-3 gap-4 mb-6 text-center">
        <div className="text-sm">
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500">Harvest Location</p>
        </div>
        <div className="text-sm">
          <p className="text-gray-500 dark:text-gray-400">2023-09-15</p>
          <p className="text-xs text-gray-400 dark:text-gray-500">Harvest Date</p>
        </div>
        <div className="text-sm">
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
        <h3 className="font-semibold text-gray-800 dark:text-white mb-4">Processing Steps</h3>
        {['Harvesting', 'Drying & Curing', 'Quality Check'].map((step, index) => (
          <div key={step} className="mb-2">
            <div className="flex items-center justify-between cursor-pointer">
              <div className="flex items-center">
                <span className="w-6 h-6 rounded-full bg-green-100 text-green-800 flex items-center justify-center text-xs mr-3">
                  {index + 1}
                </span>
      ...
      <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
        <h3 className="font-semibold text-gray-800 dark:text-white mb-4">Lab Results</h3>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="text-left text-xs text-gray-500 dark:text-gray-400">
                ...
                <th className="pb-2">Purity Level</th>
                <th className="pb-2">Contaminants</th>
...
function HomePage() {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 min-h-screen">
      <HeroSection batchId={batchId} dispatch={dispatch} isLoading={isLoading} error={error} />
      <div className="max-w-7xl mx-auto px-4 py-12">
        <FilterSection />
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-6">Recently Viewed</h2>
